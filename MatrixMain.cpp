...
Description: Functions as a test driver for
the Orthogonal List that was developed for project
3&4, covers the basic commands and abilities of the List,
including insertion, deletion, searching, transpose,
...
int main() {
	...
	cout << "Matrix A after some insertion" << endl;
	matrixA.printMatrix();
	cout << endl << endl;
